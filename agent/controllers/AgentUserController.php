...
use backend\models\search\AgentUserSearch;
...
class AgentUserController extends \yii\web\Controller
{
    ...
    public function actionUpdate($id)
    {
        ...
        if (Yii::$app->getRequest()->getIsPost()) {
            ...
            $model = AgentUser::findOne(['id' => yii::$app->getUser()->getIdentity()->getId()]);
        }
