        ...
        <div class="col-sm-12">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    ...
                    <div class="hr-line-dashed"></div>
                    <?= $form->field($model, 'status')->radioList(AgentUser::getStatuses()) ?>
                    <div class="hr-line-dashed"></div>
                    <?php
                    ...
                    <div class="form-group field-permissions">
                        <span class="col-sm-2 control-label checkbox checkbox-success"><?= Html::checkbox("", false, ['id' => 'permission-all', 'class' => 'chooseAll']) ?>
                            <label for='permission-all'><h4><?= yii::t('app', 'Permissions') ?></h4></label></span>
                        <div class="col-sm-10">
                            <?php
                            $rbac = new Rbac();
