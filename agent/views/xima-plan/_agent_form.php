                        ...
                        <tr>
                            ...
                            foreach ($levels as $idx => $level) {
                                ...
                                foreach ($platforms as $platform) {
                                    ...
                                    echo "<td>\n";
                                    echo $form->field($rateModel, '[tr-' . $idx . '][' . $platform->id . ']xima_type', ['template' => "{input}\n{error}"])->label('')->radioList(Constants::getXiMaTypes());
                                    echo $form->field($rateModel, '[tr-' . $idx . '][' . $platform->id . ']xima_rate', ['template' => "{input}\n{error}"])->label('')->textInput(['afterAddon' => '%', 'value' => $rateModel->xima_rate * 100]);
