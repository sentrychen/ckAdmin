 ...
 * @var $searchModel backend\models\search\UserXimaRecordSearch
 * @var $total array
 */
        ...
        <div class="ibox">
            ...
            <div class="ibox-content">
                <div class="toolbar clearfix" style="width: 100%">
                    <?= $this->render('_search_user_xima', ['model' => $searchModel]); ?>
                </div>
                <?= GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value' => function ($model) {
                                if ($model->ximaPlan) {
                                    return Html::a(Yii::$app->formatter->asPercent($model->xima_rate, 2), Url::to(['xima-plan/user-view', 'id' => $model->xima_plan_id]), [
